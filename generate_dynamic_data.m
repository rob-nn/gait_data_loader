function generate_dynamic_data()
	...
	dynamics_walk1 = clean_data_calculate(data_loads(1));
	dynamics_walk2 = clean_data_calculate(data_loads(2));
	dynamics_walk3 = clean_data_calculate(data_loads(3));
	dynamics_walk4 = clean_data_calculate(data_loads(4));
	dynamics_walk5 = clean_data_calculate(data_loads(5));
